...
<?php
	...
	if(!$link){
        ...
        $sql="select * from popedu where name in (select name from user where username='$username')";
...
?>
                    ...
                    <div class="conone conone-top">
                        <div class="cononetext">文化程度:<span><?php echo $row[degree] ?></span></div>
                        <div class="cononetext">英语水平:<span><?php echo $row[englevel] ?></span></div>
                    </div>
                    <div class="conone conone-top">
                        <div class="cononetext">所在（毕业）学校:<span><?php echo $row[school] ?></span></div>
                    </div>
                    <div class="con-img">
                        <img src="../images/peredu.jpg"/>
                    </div>
<?php
            }
            else{
